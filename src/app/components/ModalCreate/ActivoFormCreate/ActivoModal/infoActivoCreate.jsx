...
export default function infoActivoCreate (props) {
    ...
    const [inteValue, setIntegridadValue]= useState();
    const [inteJust, setIntegridadJust] = useState();
    const [confValue, setConfValue] = useState();
    const [confJust, setConfJust] = useState();
    const [autenValue, setAutenValue] = useState();
    const [autenJust, setAutenJust] = useState();
    const [traValue, setTraValue]= useState();
    const [traJust, setTraJust] = useState();
    const [dependeciaAct, setDependenciaAct] = useState([]);
