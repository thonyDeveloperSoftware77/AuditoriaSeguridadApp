...
import { postOrganizacion} from "../../servicios/organizacionSrv";

export default function OrganizacionModalCreate(props) {
    ...
    const editar = () => {
        postOrganizacion(nombre, sector, ubicacion, actividadPrincipal).then((response) => {
