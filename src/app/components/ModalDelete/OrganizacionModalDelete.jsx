...
import { deleteOrganizacion} from "../../servicios/organizacionSrv";

export default function OrganizacionModalDelete(props) {
    console.log("Esto es el props");
    console.log(props.data._id);
    const { onOpen } = useDisclosure();
    const editar = () => {
        deleteOrganizacion(props.data._id).then((response) => {
