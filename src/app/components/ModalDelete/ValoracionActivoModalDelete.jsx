...
import { deleteValoracionActivo} from "../../servicios/valoracionActivoSrv";

export default function ValoracionActivoModalDelete(props) {
    console.log("Esto es el props");
    console.log(props.data._id);
    const { onOpen } = useDisclosure();
    const editar = () => {
        deleteValoracionActivo(props.data._id).then((response) => {
